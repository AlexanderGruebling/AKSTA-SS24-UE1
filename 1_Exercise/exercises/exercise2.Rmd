...
If the number gets to big, the inbuilt our functions breaks, 
...
plot(x, y, type = 'l', col = 'blue', xlab = "n", ylab = expression(rho[n] / sqrt(n)), main=expression("Plot of " * rho[n] * " over " * sqrt(n)))
